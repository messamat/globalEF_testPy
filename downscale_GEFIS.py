...
#Outputs
gefis_gdb = os.path.join(datdir, 'GEFIS') #Folder to contain extracted map package
pathcheckcreate(gefis_gdb)
...
arcpy.ExtractPackage_management(in_package=gefis_mpk, output_folder=gefis_gdb)
gefis_raslist = getfilelist(gefis_gdb, repattern='.*[.]tif$')
